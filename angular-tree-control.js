      ...
      return {
        ...
        controller: ['$scope', function ($scope) {
          ...
          var template =
            ...
            '<li ' + dropArg + ' ng-if="!options.isLeaf(node)"  ng-repeat="node in node.' + $scope.options.nodeChildren + ' | filter:filterExpression:filterComparator | orderBy:orderBy:reverseOrder" ng-class="headClass(node)" ' + classIfDefined($scope.options.injectClasses.li, true) + '>' +
